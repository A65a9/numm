...
public class FlagDisplayApp extends Application {

    private final String[] countries = {"Italy", "France", "Nigeria"};
    private final Color[][] flagColors = {
            {Color.GREEN, Color.WHITE, Color.RED}, // Italy
            {Color.BLUE, Color.WHITE, Color.RED}, // France
            {Color.GREEN, Color.WHITE, Color.GREEN}   //Nigeria
    };
    ...
    public void start(Stage primaryStage) {
        ...
        HBox flagBox = new HBox(10, flagPanes);
